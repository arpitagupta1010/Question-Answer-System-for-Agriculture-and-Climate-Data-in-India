...
df = pd.read_excel(
    r"C:\Users\arpit\OneDrive\Desktop\project samarth\crop_data.xlsx",
    header=2
)
...
#  Convert numeric columns to numbers (ignore text)
for col in ["AVERAGE RAINFALL", "PRODUCTION_1", "AREA_1"]:
